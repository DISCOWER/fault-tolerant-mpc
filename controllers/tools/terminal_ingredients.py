...
class explicitMPCTerminalIngredients:
    ...
    def calculate_terminal_ingredients(self):
        ...
        input_empc_max = self.empc_bound_r
        cross_2 = 2 * input_empc_max * \
            ( abs(rNorm**2*m**4*qu2**2) * abs(eo3**4))**0.5 * 1/(1-((1-k3)**(4/2))) + ( abs((m**4*qu1**2*rNorm**4 + 2*j00*j22*m**2*qu1*qu6*rNorm**2 - 2*j11*j22*m**2*qu1*qu6*rNorm**2 + m**4*qu1**2*rNorm**2 + j00**2*j22**2*qu6**2 - 2*j00*j11*j22**2*qu6**2 + j11**2*j22**2*qu6**2)) * abs(eo1**2*eo2**2))**0.5 * 1/(1-((1-k1)**(2/2)*(1-k2)**(2/2))) + ( abs((2*m**4*qu2**2*rNorm**2 + j00**2*j11**2*qu5**2 - 2*j00*j11**2*j22*qu5**2 + j11**2*j22**2*qu5**2)) * abs(eo1**2*eo3**2))**0.5 * 1/(1-((1-k1)**(2/2)*(1-k3)**(2/2))) + ( abs((4*m**4*qu2**2*rNorm**2*omd + 2*j00**2*j11**2*qu5**2*omd - 4*j00*j11**2*j22*qu5**2*omd + 2*j11**2*j22**2*qu5**2*omd)) * abs(eo1**2*eo3))**0.5 * 1/(1-((1-k1)**(2/2)*(1-k3)**(1/2))) + ( abs((k1**2*m**4*qu3**2*rNorm**4 + 2*j00**2*k1**2*m**2*qu3*qu4*rNorm**2 + k1**2*m**4*qu3**2*rNorm**2 + j00**4*k1**2*qu4**2 + j00**2*j11**2*qu5**2*omd**2 - 2*j00*j11**2*j22*qu5**2*omd**2 + j11**2*j22**2*qu5**2*omd**2)) * abs(eo1**2))**0.5 * 1/(1-((1-k1)**(2/2))) + ( abs((-2*k1*m**4*qu3**2*rNorm**4 + 2*k3*m**4*qu1**2*rNorm**4 - 2*j00**2*k1*m**2*qu3*qu4*rNorm**2 + 2*j00*j11*k1*m**2*qu3*qu4*rNorm**2 - 2*j00*j22*k1*m**2*qu3*qu4*rNorm**2 + 2*j00*j22*k3*m**2*qu1*qu6*rNorm**2 - 2*j11*j22*k3*m**2*qu1*qu6*rNorm**2 + 2*j22**2*k3*m**2*qu1*qu6*rNorm**2 - 2*k1*m**4*qu3**2*rNorm**2 + 2*k3*m**4*qu1**2*rNorm**2 + 2*j00**3*j11*k1*qu4**2 - 2*j00**3*j22*k1*qu4**2 - 2*j00*j11**3*k2*qu5**2 + 2*j00*j22**3*k3*qu6**2 + 2*j11**3*j22*k2*qu5**2 - 2*j11*j22**3*k3*qu6**2)) * abs(eo1*eo2*eo3))**0.5 * 1/(1-((1-k1)**(1/2)*(1-k2)**(1/2)*(1-k3)**(1/2))) + ( abs((-2*k1*m**4*qu3**2*rNorm**4*omd - 2*j00**2*k1*m**2*qu3*qu4*rNorm**2*omd + 2*j00*j11*k1*m**2*qu3*qu4*rNorm**2*omd - 2*j00*j22*k1*m**2*qu3*qu4*rNorm**2*omd - 2*k1*m**4*qu3**2*rNorm**2*omd + 2*j00**3*j11*k1*qu4**2*omd - 2*j00**3*j22*k1*qu4**2*omd - 2*j00*j11**3*k2*qu5**2*omd + 2*j11**3*j22*k2*qu5**2*omd)) * abs(eo1*eo2))**0.5 * 1/(1-((1-k1)**(1/2)*(1-k2)**(1/2))) + ( abs((m**4*qu3**2*rNorm**4 - 2*j00*j11*m**2*qu3*qu4*rNorm**2 + 2*j00*j22*m**2*qu3*qu4*rNorm**2 + m**4*qu3**2*rNorm**2 + j00**2*j11**2*qu4**2 - 2*j00**2*j11*j22*qu4**2 + j00**2*j22**2*qu4**2)) * abs(eo2**2*eo3**2))**0.5 * 1/(1-((1-k2)**(2/2)*(1-k3)**(2/2))) + ( abs((2*m**4*qu3**2*rNorm**4*omd - 4*j00*j11*m**2*qu3*qu4*rNorm**2*omd + 4*j00*j22*m**2*qu3*qu4*rNorm**2*omd + 2*m**4*qu3**2*rNorm**2*omd + 2*j00**2*j11**2*qu4**2*omd - 4*j00**2*j11*j22*qu4**2*omd + 2*j00**2*j22**2*qu4**2*omd)) * abs(eo2**2*eo3))**0.5 * 1/(1-((1-k2)**(2/2)*(1-k3)**(1/2))) + ( abs((m**4*qu3**2*rNorm**4*omd**2 - 2*j00*j11*m**2*qu3*qu4*rNorm**2*omd**2 + 2*j00*j22*m**2*qu3*qu4*rNorm**2*omd**2 + m**4*qu3**2*rNorm**2*omd**2 + j00**2*j11**2*qu4**2*omd**2 - 2*j00**2*j11*j22*qu4**2*omd**2 + j00**2*j22**2*qu4**2*omd**2 + j11**4*k2**2*qu5**2)) * abs(eo2**2))**0.5 * 1/(1-((1-k2)**(2/2))) + ( abs(4*m**4*qu2**2*rNorm**2*omd) * abs(eo3**3))**0.5 * 1/(1-((1-k3)**(3/2))) + ( abs((k3**2*m**4*qu1**2*rNorm**4 + 2*j22**2*k3**2*m**2*qu1*qu6*rNorm**2 + k3**2*m**4*qu1**2*rNorm**2 + 4*m**4*qu2**2*rNorm**2*omd**2 + j22**4*k3**2*qu6**2)) * abs(eo3**2))**0.5 * 1/(1-((1-k3)**(2/2)))
