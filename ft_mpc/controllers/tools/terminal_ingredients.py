...
class explicitMPCTerminalIngredients:
    ...
    def calc_empc_input_bounds(self):
        ...
        constraints.append(emax1 == emax2)
        constraints.append(emax1 == emax3)
    ...
    def calculate_terminal_ingredients(self):
        ...
        # print(f"r: {self.empc_bound_r} - uimax : {uimax}")
        # print(f"omega: {self.empc_bound_omega.reshape(1, -1)}")
        # breakpoint()
        ...
        cross_1 = 2 * Qu_tilde_abs * \
            (4*rNorm**2*j11*omd/j00 - 4*rNorm**2*j22*omd/j00 + 2*rNorm**2*j11**2*omd/j00**2 + 2*rNorm**2*j22**2*omd/j00**2 - 4*j11*j22*omd/j00**2 + 2*rNorm**2*omd + 2*j11**2*omd/j00**2 + 2*j22**2*omd/j00**2 - 4*rNorm**2*j11*j22*omd/j00**2)*eo3*eo2**2 *1/(1-((1-k3)**1*(1-k2)**2)) + (rNorm**2 - 2*rNorm**2*j11*j22/j00**2 + j11**2/j00**2 + j22**2/j00**2 - 2*rNorm**2*j22/j00 + rNorm**2*j11**2/j00**2 + rNorm**2*j22**2/j00**2 - 2*j11*j22/j00**2 + 2*rNorm**2*j11/j00)*eo3**2*eo2**2 *1/(1-((1-k3)**2*(1-k2)**2)) + (2*j00**2*omd/j11**2 + 2*j22**2*omd/j11**2 + 4*rNorm**2*omd - 4*j00*j22*omd/j11**2)*eo3*eo1**2 *1/(1-((1-k3)**1*(1-k1)**2)) + (-2*j00*j22/j11**2 + 2*rNorm**2 + j00**2/j11**2 + j22**2/j11**2)*eo3**2*eo1**2 *1/(1-((1-k3)**2*(1-k1)**2)) + (-2*j00*j11/j22**2 + rNorm**2*j00**2/j22**2 - 2*rNorm**2*j00/j22 + rNorm**2*j11**2/j22**2 + 2*rNorm**2*j11/j22 + j00**2/j22**2 + j11**2/j22**2 + rNorm**2 - 2*rNorm**2*j00*j11/j22**2)*eo2**2*eo1**2 *1/(1-((1-k2)**2*(1-k1)**2)) + (-2*rNorm**2*j22*omd**2/j00 + rNorm**2*j11**2*omd**2/j00**2 + rNorm**2*j22**2*omd**2/j00**2 - 2*j11*j22*omd**2/j00**2 + 2*rNorm**2*j11*omd**2/j00 + j11**2*omd**2/j00**2 + j22**2*omd**2/j00**2 + rNorm**2*omd**2 - 2*rNorm**2*j11*j22*omd**2/j00**2)*eo2**2 *1/(1-((1-k2)**2)) + rNorm**2*eo3**4 *1/(1-((1-k3)**4)) + (-2*j00*j22*omd**2/j11**2 + j00**2*omd**2/j11**2 + j22**2*omd**2/j11**2)*eo1**2 *1/(1-((1-k1)**2)) + 4*rNorm**2*omd**2*eo3**2 *1/(1-((1-k3)**2)) + 4*rNorm**2*omd*eo3**3*1/(1-((1-k3)**3))
        ...
        input_empc_max = self.empc_bound_r
        def sqrtabs(x):
            # approximate sqrt(abs(x)) as sqrt(  sqrt(x^2+c) ) - sqrt(sqrt(c))
            app_val = 1.e-6
            return (x*x + app_val)**0.25 - app_val**0.25
        cross_2 = 2 * input_empc_max * \
            ( abs(rNorm**2*m**4*qu2**2))**0.5 * sqrtabs(eo3**4) * 1/(1-((1-k3)**(4/2))) + ( abs((m**4*qu1**2*rNorm**4 + 2*j00*j22*m**2*qu1*qu6*rNorm**2 - 2*j11*j22*m**2*qu1*qu6*rNorm**2 + m**4*qu1**2*rNorm**2 + j00**2*j22**2*qu6**2 - 2*j00*j11*j22**2*qu6**2 + j11**2*j22**2*qu6**2)) )**0.5* sqrtabs(eo1**2*eo2**2) * 1/(1-((1-k1)**(2/2)*(1-k2)**(2/2))) + ( abs((2*m**4*qu2**2*rNorm**2 + j00**2*j11**2*qu5**2 - 2*j00*j11**2*j22*qu5**2 + j11**2*j22**2*qu5**2)) )**0.5* sqrtabs(eo1**2*eo3**2) * 1/(1-((1-k1)**(2/2)*(1-k3)**(2/2))) + ( abs((4*m**4*qu2**2*rNorm**2*omd + 2*j00**2*j11**2*qu5**2*omd - 4*j00*j11**2*j22*qu5**2*omd + 2*j11**2*j22**2*qu5**2*omd)) )**0.5* sqrtabs(eo1**2*eo3) * 1/(1-((1-k1)**(2/2)*(1-k3)**(1/2))) + ( abs((k1**2*m**4*qu3**2*rNorm**4 + 2*j00**2*k1**2*m**2*qu3*qu4*rNorm**2 + k1**2*m**4*qu3**2*rNorm**2 + j00**4*k1**2*qu4**2 + j00**2*j11**2*qu5**2*omd**2 - 2*j00*j11**2*j22*qu5**2*omd**2 + j11**2*j22**2*qu5**2*omd**2)) )**0.5* sqrtabs(eo1**2) * 1/(1-((1-k1)**(2/2))) + ( abs((-2*k1*m**4*qu3**2*rNorm**4 + 2*k3*m**4*qu1**2*rNorm**4 - 2*j00**2*k1*m**2*qu3*qu4*rNorm**2 + 2*j00*j11*k1*m**2*qu3*qu4*rNorm**2 - 2*j00*j22*k1*m**2*qu3*qu4*rNorm**2 + 2*j00*j22*k3*m**2*qu1*qu6*rNorm**2 - 2*j11*j22*k3*m**2*qu1*qu6*rNorm**2 + 2*j22**2*k3*m**2*qu1*qu6*rNorm**2 - 2*k1*m**4*qu3**2*rNorm**2 + 2*k3*m**4*qu1**2*rNorm**2 + 2*j00**3*j11*k1*qu4**2 - 2*j00**3*j22*k1*qu4**2 - 2*j00*j11**3*k2*qu5**2 + 2*j00*j22**3*k3*qu6**2 + 2*j11**3*j22*k2*qu5**2 - 2*j11*j22**3*k3*qu6**2)) )**0.5* sqrtabs(eo1*eo2*eo3) * 1/(1-((1-k1)**(1/2)*(1-k2)**(1/2)*(1-k3)**(1/2))) + ( abs((-2*k1*m**4*qu3**2*rNorm**4*omd - 2*j00**2*k1*m**2*qu3*qu4*rNorm**2*omd + 2*j00*j11*k1*m**2*qu3*qu4*rNorm**2*omd - 2*j00*j22*k1*m**2*qu3*qu4*rNorm**2*omd - 2*k1*m**4*qu3**2*rNorm**2*omd + 2*j00**3*j11*k1*qu4**2*omd - 2*j00**3*j22*k1*qu4**2*omd - 2*j00*j11**3*k2*qu5**2*omd + 2*j11**3*j22*k2*qu5**2*omd)) )**0.5* sqrtabs(eo1*eo2) * 1/(1-((1-k1)**(1/2)*(1-k2)**(1/2))) + ( abs((m**4*qu3**2*rNorm**4 - 2*j00*j11*m**2*qu3*qu4*rNorm**2 + 2*j00*j22*m**2*qu3*qu4*rNorm**2 + m**4*qu3**2*rNorm**2 + j00**2*j11**2*qu4**2 - 2*j00**2*j11*j22*qu4**2 + j00**2*j22**2*qu4**2)) )**0.5* sqrtabs(eo2**2*eo3**2) * 1/(1-((1-k2)**(2/2)*(1-k3)**(2/2))) + ( abs((2*m**4*qu3**2*rNorm**4*omd - 4*j00*j11*m**2*qu3*qu4*rNorm**2*omd + 4*j00*j22*m**2*qu3*qu4*rNorm**2*omd + 2*m**4*qu3**2*rNorm**2*omd + 2*j00**2*j11**2*qu4**2*omd - 4*j00**2*j11*j22*qu4**2*omd + 2*j00**2*j22**2*qu4**2*omd)) )**0.5* sqrtabs(eo2**2*eo3) * 1/(1-((1-k2)**(2/2)*(1-k3)**(1/2))) + ( abs((m**4*qu3**2*rNorm**4*omd**2 - 2*j00*j11*m**2*qu3*qu4*rNorm**2*omd**2 + 2*j00*j22*m**2*qu3*qu4*rNorm**2*omd**2 + m**4*qu3**2*rNorm**2*omd**2 + j00**2*j11**2*qu4**2*omd**2 - 2*j00**2*j11*j22*qu4**2*omd**2 + j00**2*j22**2*qu4**2*omd**2 + j11**4*k2**2*qu5**2)) )**0.5* sqrtabs(eo2**2) * 1/(1-((1-k2)**(2/2))) + ( abs(4*m**4*qu2**2*rNorm**2*omd) )**0.5* sqrtabs(eo3**3) * 1/(1-((1-k3)**(3/2))) + ( abs((k3**2*m**4*qu1**2*rNorm**4 + 2*j22**2*k3**2*m**2*qu1*qu6*rNorm**2 + k3**2*m**4*qu1**2*rNorm**2 + 4*m**4*qu2**2*rNorm**2*omd**2 + j22**4*k3**2*qu6**2)) )**0.5 * sqrtabs(eo3**2)* 1/(1-((1-k3)**(2/2)))
            # ( abs(rNorm**2*m**4*qu2**2) * myabs(eo3**4))**0.5 * 1/(1-((1-k3)**(4/2))) + ( abs((m**4*qu1**2*rNorm**4 + 2*j00*j22*m**2*qu1*qu6*rNorm**2 - 2*j11*j22*m**2*qu1*qu6*rNorm**2 + m**4*qu1**2*rNorm**2 + j00**2*j22**2*qu6**2 - 2*j00*j11*j22**2*qu6**2 + j11**2*j22**2*qu6**2)) * myabs(eo1**2*eo2**2))**0.5 * 1/(1-((1-k1)**(2/2)*(1-k2)**(2/2))) + ( abs((2*m**4*qu2**2*rNorm**2 + j00**2*j11**2*qu5**2 - 2*j00*j11**2*j22*qu5**2 + j11**2*j22**2*qu5**2)) * myabs(eo1**2*eo3**2))**0.5 * 1/(1-((1-k1)**(2/2)*(1-k3)**(2/2))) + ( abs((4*m**4*qu2**2*rNorm**2*omd + 2*j00**2*j11**2*qu5**2*omd - 4*j00*j11**2*j22*qu5**2*omd + 2*j11**2*j22**2*qu5**2*omd)) * myabs(eo1**2*eo3))**0.5 * 1/(1-((1-k1)**(2/2)*(1-k3)**(1/2))) + ( abs((k1**2*m**4*qu3**2*rNorm**4 + 2*j00**2*k1**2*m**2*qu3*qu4*rNorm**2 + k1**2*m**4*qu3**2*rNorm**2 + j00**4*k1**2*qu4**2 + j00**2*j11**2*qu5**2*omd**2 - 2*j00*j11**2*j22*qu5**2*omd**2 + j11**2*j22**2*qu5**2*omd**2)) * myabs(eo1**2))**0.5 * 1/(1-((1-k1)**(2/2))) + ( abs((-2*k1*m**4*qu3**2*rNorm**4 + 2*k3*m**4*qu1**2*rNorm**4 - 2*j00**2*k1*m**2*qu3*qu4*rNorm**2 + 2*j00*j11*k1*m**2*qu3*qu4*rNorm**2 - 2*j00*j22*k1*m**2*qu3*qu4*rNorm**2 + 2*j00*j22*k3*m**2*qu1*qu6*rNorm**2 - 2*j11*j22*k3*m**2*qu1*qu6*rNorm**2 + 2*j22**2*k3*m**2*qu1*qu6*rNorm**2 - 2*k1*m**4*qu3**2*rNorm**2 + 2*k3*m**4*qu1**2*rNorm**2 + 2*j00**3*j11*k1*qu4**2 - 2*j00**3*j22*k1*qu4**2 - 2*j00*j11**3*k2*qu5**2 + 2*j00*j22**3*k3*qu6**2 + 2*j11**3*j22*k2*qu5**2 - 2*j11*j22**3*k3*qu6**2)) * myabs(eo1*eo2*eo3))**0.5 * 1/(1-((1-k1)**(1/2)*(1-k2)**(1/2)*(1-k3)**(1/2))) + ( abs((-2*k1*m**4*qu3**2*rNorm**4*omd - 2*j00**2*k1*m**2*qu3*qu4*rNorm**2*omd + 2*j00*j11*k1*m**2*qu3*qu4*rNorm**2*omd - 2*j00*j22*k1*m**2*qu3*qu4*rNorm**2*omd - 2*k1*m**4*qu3**2*rNorm**2*omd + 2*j00**3*j11*k1*qu4**2*omd - 2*j00**3*j22*k1*qu4**2*omd - 2*j00*j11**3*k2*qu5**2*omd + 2*j11**3*j22*k2*qu5**2*omd)) * myabs(eo1*eo2))**0.5 * 1/(1-((1-k1)**(1/2)*(1-k2)**(1/2))) + ( abs((m**4*qu3**2*rNorm**4 - 2*j00*j11*m**2*qu3*qu4*rNorm**2 + 2*j00*j22*m**2*qu3*qu4*rNorm**2 + m**4*qu3**2*rNorm**2 + j00**2*j11**2*qu4**2 - 2*j00**2*j11*j22*qu4**2 + j00**2*j22**2*qu4**2)) * myabs(eo2**2*eo3**2))**0.5 * 1/(1-((1-k2)**(2/2)*(1-k3)**(2/2))) + ( abs((2*m**4*qu3**2*rNorm**4*omd - 4*j00*j11*m**2*qu3*qu4*rNorm**2*omd + 4*j00*j22*m**2*qu3*qu4*rNorm**2*omd + 2*m**4*qu3**2*rNorm**2*omd + 2*j00**2*j11**2*qu4**2*omd - 4*j00**2*j11*j22*qu4**2*omd + 2*j00**2*j22**2*qu4**2*omd)) * myabs(eo2**2*eo3))**0.5 * 1/(1-((1-k2)**(2/2)*(1-k3)**(1/2))) + ( abs((m**4*qu3**2*rNorm**4*omd**2 - 2*j00*j11*m**2*qu3*qu4*rNorm**2*omd**2 + 2*j00*j22*m**2*qu3*qu4*rNorm**2*omd**2 + m**4*qu3**2*rNorm**2*omd**2 + j00**2*j11**2*qu4**2*omd**2 - 2*j00**2*j11*j22*qu4**2*omd**2 + j00**2*j22**2*qu4**2*omd**2 + j11**4*k2**2*qu5**2)) * myabs(eo2**2))**0.5 * 1/(1-((1-k2)**(2/2))) + ( abs(4*m**4*qu2**2*rNorm**2*omd) * myabs(eo3**3))**0.5 * 1/(1-((1-k3)**(3/2))) + ( abs((k3**2*m**4*qu1**2*rNorm**4 + 2*j22**2*k3**2*m**2*qu1*qu6*rNorm**2 + k3**2*m**4*qu1**2*rNorm**2 + 4*m**4*qu2**2*rNorm**2*omd**2 + j22**4*k3**2*qu6**2)) * myabs(eo3**2))**0.5 * 1/(1-((1-k3)**(2/2)))
